...
//connect to database
mysql_connect("db655937740.db.1and1.com", "dbo655937740", "Massadas");
mysql_select_db("db655937740"); //your database
...
if(isset($_POST["Go"]) && ""!=$_POST["Go"]) //form was submitted
{
  ...
  //Target DB Table for the import
  $csv->table_name = "test_prods";
